...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // appBar: AppBar(),
        body:LandscapeView(middleRatio: 2,
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      "Toh Apki kis Prakar Se Saheta Kre?",
                      style: TextStyle(
                        color: AppColors.darkBlueTheme,
                        fontSize: 18,
                        fontWeight: FontWeight.w600,
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(color: AppColors.lightBlueTheme, width: 1.5),
                            color: currentTab == 0 ? AppColors.lightBlueTheme : Colors.white,
                        ),
                        child: Center(
                          child: Text(
                            "Trending",
                            style: TextStyle(
                              fontSize: 14,
                              color: currentTab == 0 ? Colors.white : AppColors.darkBlueTheme,
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(20),
                            border: Border.all(color: AppColors.lightBlueTheme, width: 1.5),
                            color: currentTab == 1 ? AppColors.lightBlueTheme : Colors.white,
                        ),
                        child: Center(
                          child: Text(
                            "Hostel",
                            style: TextStyle(
                              fontSize: 14,
                              color: currentTab == 1 ? Colors.white : AppColors.darkBlueTheme,
                              fontWeight: FontWeight.bold,
                            ),
                          ),
                        ),
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(20),
                          border: Border.all(color: AppColors.lightBlueTheme, width: 1.5),
                          color: currentTab == 2 ? AppColors.lightBlueTheme : Colors.white,
                        ),
                        child: Center(
                          child: Text(
                            "PG",
                            style: TextStyle(
                              fontSize: 14,
                              color: currentTab == 2 ? Colors.white : AppColors.darkBlueTheme,
                              fontWeight: FontWeight.bold,
                            ),
                          ),
                        ),
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(20),
                          border: Border.all(color: AppColors.lightBlueTheme, width: 1.5),
                          color: currentTab == 3 ? AppColors.lightBlueTheme : Colors.white,
                        ),
                        child: Center(
                          child: Text(
                            "Flat",
                            style: TextStyle(
                              fontSize: 14,
                              color: currentTab == 3 ? Colors.white : AppColors.darkBlueTheme,
                              fontWeight: FontWeight.bold,
                            ),
                          ),
                        ),
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(20),
                          border: Border.all(color: AppColors.lightBlueTheme, width: 1.5),
                          color: currentTab == 4 ? AppColors.lightBlueTheme : Colors.white,
                        ),
                        child: Center(
                          child: Text(
                            "Laundry",
                            style: TextStyle(
                              fontSize: 14,
                              color: currentTab == 4 ? Colors.white : AppColors.darkBlueTheme,
                              fontWeight: FontWeight.bold,
                            ),
                          ),
                        ),
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(20),
                          border: Border.all(color: AppColors.lightBlueTheme, width: 1.5),
                          color: currentTab == 5 ? AppColors.lightBlueTheme : Colors.white,
                        ),
                        child: Center(
                          child: Text(
                            "Cab",
                            style: TextStyle(
                              fontSize: 14,
                              color: currentTab == 5 ? Colors.white : AppColors.darkBlueTheme,
                              fontWeight: FontWeight.bold,
                            ),
                          ),
                        ),
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(color: DarkBlueTheme),
            ...
            decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                      ...
                      spreadRadius: isTablet?0.3:-1,offset: isTablet?Offset(0,0):Offset(0,-2)),
                ]
            ),
            height: 75,
    ...
    Services(int index) {
     return Center(
       child: Container(
          width:Screen.isPortrait(context)? MediaQuery.of(context).size.width/2.1:MediaQuery.of(context).size.width /4,
    ...
    bottomCards(int index){
      return Container(
        width: Screen.isPortrait(context)? MediaQuery.of(context).size.width/3.2:MediaQuery.of(context).size.width /6,
        height: 150,// Half of the screen width
        child: Card(
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(30.0), // Adjust the value for desired curve
          ...
          child: ListTile(
            title: Text(index==0?"Flat":index==1?"PG":"Laundry"),
            // subtitle: Text('Card Subtitle'),
